...
TEST_CASE("sum_to_4_yields_3") { REQUIRE(3 == sum_of_multiples::to({3, 5}, 4)); }
...
TEST_CASE("sum_of_1_to_100") { REQUIRE(4950 == sum_of_multiples::to({1}, 100)); }

TEST_CASE("sum_of_empty_list") { REQUIRE(0 == sum_of_multiples::to({}, 10000)); }
